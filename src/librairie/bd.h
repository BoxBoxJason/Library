...
public:
    BD(const QString& auteur, const QString& titre, const QString& editeur, int isbn, const QString& public_cible,const QString& dessinateur,int code_bibliotheque_origine=-1);
